...
const GOOGLE_CLIENT_ID =
  "857779810805-sbojmllvthbp03kjeuanbjn0a0neugfq.apps.googleusercontent.com";
...
const Auth = () => {
  ...
  return (
    ...
    <GoogleOAuthProvider clientId={GOOGLE_CLIENT_ID}>
      {/* Dashboard Button - Positioned at Top Right */}
              ...
              <Card>
                ...
                <div className="mt-4">
                  <GoogleLogin
                    ...
                    render={(renderProps) => (
                      <Button
                        className="w-3/4 h-14 flex items-center justify-center space-x-2 bg-gray-100 border border-gray-300 text-gray-600 hover:bg-gray-200"
                        onClick={renderProps.onClick}
                        disabled={renderProps.disabled}
                      >
                        <FcGoogle size={24} />
