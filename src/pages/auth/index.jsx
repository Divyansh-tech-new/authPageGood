  ...
  return (
    <GoogleOAuthProvider clientId={GOOGLE_CLIENT_ID}>
      ...
      <div className="w-full h-screen flex">
        ...
        <div className="mt-20">
        <button className="p-[4px] relative"> {/* Increased padding for a bigger button */}
...
<img src={pic} alt="helloS" className="w-60 h-60 object-contain" />
 ...
 <div className="flex space-x-4 justify-center"> {/* Flex container for horizontal alignment */}
            {connected ? (
              <>
